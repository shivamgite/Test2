...
public class DriverFactory{
    ...
    public WebDriver createDriver() {
        try {
        	...
        	//String driverPath = "/home/dell/Desktop/ShivaJars/chromedriver_linux64/chromedriver";
        	String driverPath = "Driver/chromedriver";
    		//driverPath = driverPath+ "/" +"chromedriver";
            System.setProperty( "webdriver.chrome.driver", driverPath );
            String logFilePath = "/home/dell/shivaNewWorkspace/developmentDemo3/chromeLogPath/myChromeLOgs_"+currTime+".log";
            ...
            //Added below 4 options to overcome chrome initialization issue in automated environment
